...
int quick_edge_init(const char *device_name, const char *community_name,
                    const char *encrypt_key, const char *device_mac,
                    const char *local_ip_address,
                    const char *supernode_ip_address_port,
                    const int *keep_on_running) {
  tuntap_dev tuntap;
  n2n_edge_t *eee;
  n2n_edge_conf_t conf;
  int rv;
